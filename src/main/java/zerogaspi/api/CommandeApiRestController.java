...
public class CommandeApiRestController {
	...
	@GetMapping("")
	@JsonView(IViews.IViewCommandeWithLotAndClient.class)
	...
	@JsonView(IViews.IViewCommandePayanteWithLotAndClient.class)
	...
	@JsonView(IViewCommandeGratuiteWithLotAndClient.class)
